...
GRAPH = {'aac_adtstoasc_bsf': {'select': ['adts_header', 'mpeg4audio']},
 ...
 'aac_encoder': {'select': ['audio_frame_queue', 'lpc', 'sinewin']},
 'aac_fixed_decoder': {'select': ['adts_header', 'mpeg4audio']},
 'aac_latm_decoder': {'select': ['aac_decoder', 'aac_latm_parser']},
 'aac_mediacodec_decoder': {'deps': ['mediacodec'],
                            'select': ['aac_adtstoasc_bsf', 'aac_parser']},
 ...
 'acelp_kelvin_decoder': {'select': ['audiodsp', 'celp_math']},
 'act_demuxer': {'select': ['riffdec']},
 'adpcm_circus_decoder': {'deps': ['lgpl_gpl']},
 'adpcm_g722_decoder': {'select': ['g722dsp']},
 'adpcm_g722_encoder': {'select': ['g722dsp']},
 'adpcm_ima_escape_decoder': {'deps': ['lgpl_gpl']},
 'adpcm_ima_hvqm2_decoder': {'deps': ['lgpl_gpl']},
 'adpcm_ima_hvqm4_decoder': {'deps': ['lgpl_gpl']},
 'adpcm_ima_magix_decoder': {'deps': ['lgpl_gpl']},
 'adpcm_ima_pda_decoder': {'deps': ['lgpl_gpl']},
 'adpcm_ima_qt_at_decoder': {'deps': ['audiotoolbox']},
 'adpcm_n64_decoder': {'deps': ['lgpl_gpl']},
 'adpcm_psxc_decoder': {'deps': ['lgpl_gpl']},
 'adts_muxer': {'select': ['mpeg4audio']},
 'aesni': {'deps': ['sse42']},
 'agm_decoder': {'select': ['idctdsp']},
 'ahx_decoder': {'deps': ['lgpl_gpl'],
                 'select': ['mpegaudio', 'ahx_to_mp2_bsf']},
 'ahx_parser': {'deps': ['lgpl_gpl']},
 'ahx_to_mp2_bsf': {'deps': ['lgpl_gpl']},
 ...
 'amf_capture_filter': {'deps': ['amf']},
 'amovie_filter': {'deps': ['avcodec', 'avformat']},
 'amr_nb_at_decoder': {'deps': ['audiotoolbox']},
 'amrnb_decoder': {'select': ['lsp', 'celp_math']},
 'amrnb_mediacodec_decoder': {'deps': ['mediacodec'], 'select': ['amr_parser']},
 'amrwb_decoder': {'select': ['lsp', 'celp_math']},
 'amrwb_mediacodec_decoder': {'deps': ['mediacodec'], 'select': ['amr_parser']},
 'amv_decoder': {'select': ['sp5x_decoder']},
 ...
 'android_camera_indev': {'deps': ['android',
                                   ...
                                   'mediandk',
                                   'pthreads']},
 'android_content_protocol': {'deps': ['jni'], 'select': ['file_protocol']},
 ...
 'apv_decoder': {'select': ['cbs_apv']},
 'apv_demuxer': {'select': ['apv_parser']},
 'apv_parser': {'select': ['cbs_apv']},
 'aresample_filter': {'deps': ['swresample']},
 'arm_crc': {'deps': ['aarch64']},
 'armv5te': {'deps': ['arm']},
 'armv6': {'deps': ['arm']},
 'armv6t2': {'deps': ['arm']},
 'armv8': {'deps': ['aarch64']},
 ...
 'atomics_native': {'if_any': ['atomics_win32']}, # MANUAL
 'atrac1_decoder': {'select': ['sinewin']},
 'atrac3p_decoder': {'select': ['sinewin']},
 'atrac3pal_decoder': {'select': ['sinewin']},
 'audiotoolbox_outdev': {'deps': ['audiotoolbox',
                                  'pthreads',
                                  'audioobjectpropertyaddress']},
 'av1_amf_decoder': {'deps': ['amf']},
 ...
 'av1_d3d11va_hwaccel': {'deps': ['d3d11va', 'dxva_picparams_av1'],
                         'select': ['av1_decoder']},
 'av1_d3d12va_encoder': {'deps': ['d3d12va', 'd3d12va_av1_headers'],
                         'select': ['cbs_av1', 'd3d12va_encode']},
 'av1_d3d12va_hwaccel': {'deps': ['d3d12va', 'dxva_picparams_av1'],
                         'select': ['av1_decoder']},
 'av1_decoder': {'select': ['atsc_a53', 'cbs_av1', 'dovi_rpudec']},
 ...
 'av1_mediacodec_encoder': {'deps': ['mediacodec'],
                            'select': ['extract_extradata_bsf']},
 'av1_metadata_bsf': {'select': ['cbs_av1']},
 'av1_mf_encoder': {'deps': ['mediafoundation']},
 ...
 'av1_vaapi_encoder': {'deps': ['vaencpictureparameterbufferav1'],
                       'select': ['cbs_av1', 'vaapi_encode']},
 'av1_vaapi_hwaccel': {'deps': ['vaapi',
                                'vadecpictureparameterbufferav1_bit_depth_idx'],
                       'select': ['av1_decoder']},
 'av1_vdpau_hwaccel': {'deps': ['vdpau', 'vdppictureinfoav1'],
                       'select': ['av1_decoder']},
 'av1_videotoolbox_hwaccel': {'deps': ['videotoolbox'],
                              'select': ['av1_decoder']},
 'av1_vulkan_encoder': {'deps': ['vulkan_1_4'],
                        'select': ['cbs_av1', 'vulkan_encode']},
 'av1_vulkan_hwaccel': {'deps': ['vulkan'], 'select': ['av1_decoder']},
 'avcodec': {'deps': ['avutil'], 'suggest': ['libm', 'stdatomic', 'zlib']},
 'avdevice': {'deps': ['avformat', 'avcodec', 'avutil'],
              'suggest': ['libm', 'stdatomic']},
 'avfilter': {'deps': ['avutil'],
              'suggest': ['libm', 'stdatomic', 'zlib', 'spirv_library']},
 ...
 'blackdetect_vulkan_filter': {'deps': ['vulkan', 'spirv_library']},
 'blackframe_filter': {'deps': ['gpl']},
 'blend_vulkan_filter': {'deps': ['vulkan', 'spirv_library']},
 'bluray_protocol': {'deps': ['libbluray']},
 'boxblur_filter': {'deps': ['gpl']},
 'boxblur_opencl_filter': {'deps': ['opencl', 'gpl']},
 'bs2b_filter': {'deps': ['libbs2b']},
 'bwdif_cuda_filter': {'deps': ['ffnvcodec'],
                       'deps_any': ['cuda_nvcc', 'cuda_llvm']},
 'bwdif_vulkan_filter': {'deps': ['vulkan', 'spirv_compiler']},
 ...
 'cbs_h266': {'select': ['cbs']},
 'cbs_jpeg': {'select': ['cbs']},
 'cbs_lcevc': {'select': ['cbs']},
 'cbs_mpeg2': {'select': ['cbs']},
 'cbs_vp8': {'select': ['cbs']},
 'cbs_vp9': {'select': ['cbs']},
 'chromaber_vulkan_filter': {'deps': ['vulkan', 'spirv_library']},
 ...
 'clmul': {'deps': ['sse42']},
 'color_vulkan_filter': {'deps': ['vulkan', 'spirv_library']},
 ...
 'd3d12va': {'deps': ['dxva_h', 'id3d12device', 'id3d12videodecoder']},
 'd3d12va_encode': {'deps': ['d3d12va',
                             'id3d12videoencoder',
                             'd3d12_encoder_feature']},
 'dash_demuxer': {'deps': ['libxml2']},
 'dash_muxer': {'select': ['mp4_muxer']},
 'daud_muxer': {'select': ['pcm_rechunk_bsf']},
 'dcbzl': {'deps': ['ppc']},
 ...
 'deinterlace_d3d12_filter': {'deps': ['d3d12va', 'id3d12videoprocessor']},
 ...
 'dnn': {'deps': ['avformat', 'swscale'],
         'deps_any': ['libtensorflow', 'libopenvino', 'libtorch']},
 ...
 'dotprod': {'deps': ['aarch64', 'neon']},
 'dovi_rpu_bsf': {'select': ['cbs_h265',
                             'cbs_av1',
                             'dovi_rpudec',
                             'dovi_rpuenc']},
 'dovi_rpudec': {'select': ['golomb']},
 'dovi_rpuenc': {'select': ['golomb']},
 'dpx_vulkan_hwaccel': {'deps': ['vulkan', 'spirv_compiler'],
                        'select': ['dpx_decoder']},
 'drawbox_vaapi_filter': {'deps': ['vaapi_1']},
 'drawtext_filter': {'deps': ['libfreetype', 'libharfbuzz'],
                     'suggest': ['libfontconfig', 'libfribidi']},
 'drawvg_filter': {'deps': ['cairo']},
 'dshow_indev': {'deps': ['ibasefilter']},
 'dtls_protocol': {'deps_any': ['openssl', 'schannel', 'gnutls', 'mbedtls'],
                   'select': ['udp_protocol']},
 'dts2pts_bsf': {'select': ['cbs_h264',
                            'h264parse',
                            'cbs_h265',
                            'hevc_parser']},
 ...
 'dvdvideo_demuxer': {'deps': ['libdvdnav', 'libdvdread'],
                      'select': ['mpegps_demuxer']},
 ...
 'dxv_encoder': {'select': ['texturedspenc']},
 ...
 'eia608_to_smpte436m_bsf': {'select': ['smpte_436m']},
 ...
 'evc_demuxer': {'select': ['evc_frame_merge_bsf', 'evc_parser']},
 'evc_frame_merge_bsf': {'select': ['evcparse']},
 'evc_parser': {'select': ['evcparse']},
 'evcparse': {'select': ['golomb']},
 'exr_decoder': {'deps': ['zlib'], 'select': ['bswapdsp']},
 ...
 'fast_64bit': {'if_any': ['aarch64',
                           ...
                           'sparc64',
                           'x86_64']},
 'fast_clz': {'if_any': ['aarch64', 'mips', 'ppc', 'x86']},
 ...
 'ffplay': {'deps': ['avcodec',
            ...
            'select': ['crop_filter',
                       ...
                       'vflip_filter',
                       'rotate_filter'],
            'suggest': ['shell32', 'libplacebo', 'vulkan']},
 ...
 'ffv1_parser': {'select': ['rangecoder']},
 'ffv1_vulkan_encoder': {'select': ['vulkan', 'spirv_compiler']},
 'ffv1_vulkan_hwaccel': {'deps': ['vulkan', 'spirv_compiler'],
                         'select': ['ffv1_decoder']},
 ...
 'fsync_filter': {'deps': ['avformat']},
 'ftp_protocol': {'select': ['tcp_protocol']},
 'ftr_decoder': {'select': ['adts_header']},
 'ftr_parser': {'select': ['adts_header', 'mpeg4audio']},
 'g2m_decoder': {'deps': ['zlib'],
                 'select': ['blockdsp', 'idctdsp', 'jpegtables']},
 'g723_1_decoder': {'select': ['celp_math']},
 'g723_1_encoder': {'select': ['celp_math']},
 'g729_decoder': {'select': ['audiodsp', 'celp_math']},
 'gblur_vulkan_filter': {'deps': ['vulkan', 'spirv_library']},
 'gdigrab_indev': {'deps': ['createdibsection'], 'select': ['bmp_decoder']},
 'gfxcapture_filter': {'deps': ['cxx17',
                                'threads',
                                'd3d11va',
 ...
 'h263_decoder': {'select': ['h263dsp', 'mpegvideodec']},
 ...
 'h264_d3d12va_encoder': {'select': ['cbs_h264', 'd3d12va_encode']},
 'h264_d3d12va_hwaccel': {'deps': ['d3d12va'], 'select': ['h264_decoder']},
 ...
 'h264_oh_decoder': {'deps': ['ohcodec'], 'select': ['h264_mp4toannexb_bsf']},
 'h264_oh_encoder': {'deps': ['ohcodec']},
 ...
 'h264_videotoolbox_hwaccel': {'deps': ['videotoolbox'],
                               'select': ['h264_decoder']},
 'h264_vulkan_encoder': {'select': ['atsc_a53', 'cbs_h264', 'vulkan_encode']},
 'h264_vulkan_hwaccel': {'deps': ['vulkan'], 'select': ['h264_decoder']},
 ...
 'hevc_d3d11va_hwaccel': {'deps': ['d3d11va', 'dxva_picparams_hevc'],
                          'select': ['hevc_decoder']},
 'hevc_d3d12va_encoder': {'select': ['cbs_h265', 'd3d12va_encode']},
 'hevc_d3d12va_hwaccel': {'deps': ['d3d12va', 'dxva_picparams_hevc'],
                          'select': ['hevc_decoder']},
 ...
 'hevc_oh_decoder': {'deps': ['ohcodec'], 'select': ['hevc_mp4toannexb_bsf']},
 'hevc_oh_encoder': {'deps': ['ohcodec']},
 ...
 'hevc_videotoolbox_hwaccel': {'deps': ['videotoolbox'],
                               'select': ['hevc_decoder']},
 'hevc_vulkan_encoder': {'select': ['atsc_a53', 'cbs_h265', 'vulkan_encode']},
 'hevc_vulkan_hwaccel': {'deps': ['vulkan'], 'select': ['hevc_decoder']},
 'hevcparse': {'select': ['golomb']},
 'hflip_vulkan_filter': {'deps': ['vulkan', 'spirv_library']},
 'histeq_filter': {'deps': ['gpl']},
 'hls_demuxer': {'select': ['aac_demuxer',
                            'ac3_demuxer',
                            'adts_header',
                            'ac3_parser',
                            'eac3_demuxer',
                            'mov_demuxer',
                            'mpegts_demuxer']},
 'hls_muxer': {'select': ['mov_muxer', 'mpegts_muxer', 'webvtt_muxer']},
 ...
 'hxvs_demuxer': {'select': ['h264_parser', 'hevc_parser']},
 'hymt_decoder': {'select': ['huffyuv_decoder']},
 'i686': {'deps': ['x86']},
 'i8mm': {'deps': ['aarch64', 'neon']},
 'iac_decoder': {'select': ['imc_decoder']},
 'iamf_demuxer': {'select': ['iamfdec']},
 'iamf_muxer': {'select': ['iamfenc']},
 ...
 'identity_filter': {'select': ['scene_sad']},
 ...
 'lcevc_filter': {'deps': ['liblcevc_dec']},
 'lcevc_metadata_bsf': {'select': ['cbs_lcevc']},
 'ldbrx': {'deps': ['ppc']},
 'lead_decoder': {'select': ['blockdsp', 'idctdsp', 'jpegtables']},
 ...
 'libaom_av1_encoder': {'deps': ['libaom'],
                        'select': ['extract_extradata_bsf', 'dovi_rpuenc']},
 'libaribb24_decoder': {'deps': ['libaribb24']},
 'libaribcaption_decoder': {'deps': ['libaribcaption']},
 ...
 'libjxl_anim_decoder': {'deps': ['libjxl', 'libjxl_threads']},
 'libjxl_anim_encoder': {'deps': ['libjxl', 'libjxl_threads']},
 'libjxl_decoder': {'deps': ['libjxl', 'libjxl_threads']},
 'libjxl_encoder': {'deps': ['libjxl', 'libjxl_threads']},
 'libkvazaar_encoder': {'deps': ['libkvazaar']},
 'liblc3_decoder': {'deps': ['liblc3']},
 'liblc3_encoder': {'deps': ['liblc3'], 'select': ['audio_frame_queue']},
 'libmodplug_demuxer': {'deps': ['libmodplug']},
 'libmp3lame_encoder': {'deps': ['libmp3lame'],
                        'select': ['audio_frame_queue', 'mpegaudioheader']},
 'libmpeghdec_decoder': {'deps': ['libmpeghdec']},
 'liboapv_encoder': {'deps': ['liboapv']},
 'libopencolorio_filter': {'deps': ['libopencolorio']},
 ...
 'libsvtav1_encoder': {'deps': ['libsvtav1'], 'select': ['dovi_rpuenc']},
 'libsvtjpegxs_decoder': {'deps': ['libsvtjpegxs']},
 'libsvtjpegxs_encoder': {'deps': ['libsvtjpegxs']},
 ...
 'libvmaf_cuda_filter': {'deps': ['libvmaf', 'libvmaf_cuda', 'ffnvcodec']},
 ...
 'matroska_muxer': {'select': ['iso_writer',
                               'mpeg4audio',
                               'riffenc',
                               'aac_adtstoasc_bsf',
                               'pgs_frame_merge_bsf',
                               'vp9_superframe_bsf']},
 'mcc_demuxer': {'select': ['smpte_436m']},
 'mcc_muxer': {'select': ['smpte_436m'],
               'suggest': ['eia608_to_smpte436m_bsf']},
 ...
 'mediacodec': {'deps': ['android', 'mediandk', 'pthreads']},
 'mediafoundation': {'deps': ['mftransform_h', 'mfcreatealignedmemorybuffer']},
 'mestimate_d3d12_filter': {'deps': ['d3d12va',
 ...
 'mjpeg_decoder': {'select': ['blockdsp', 'idctdsp', 'jpegtables']},
 ...
 'mjpegb_decoder': {'select': ['hpeldsp', 'mjpeg_decoder']},
 ...
 'mov_demuxer': {'select': ['iso_media', 'riffdec'],
                 'suggest': ['iamfdec', 'zlib']},
 ...
 'mp3_mediacodec_decoder': {'deps': ['mediacodec'],
 ...
 'mpeg2_d3d11va_hwaccel': {'deps': ['d3d11va'],
                           'select': ['mpeg2video_decoder']},
 'mpeg2_d3d12va_hwaccel': {'deps': ['d3d12va'],
                           'select': ['mpeg2video_decoder']},
 ...
 'mpeg4_decoder': {'select': ['h263_decoder', 'qpeldsp']},
 'mpeg4_encoder': {'select': ['h263_encoder', 'qpeldsp']},
 'mpeg4_mediacodec_decoder': {'deps': ['mediacodec']},
 'mpeg4_mediacodec_encoder': {'deps': ['mediacodec'],
                              'select': ['extract_extradata_bsf']},
 ...
 'mpeg4video_parser': {'select': ['mpegvideodec']},
 ...
 'mss2_decoder': {'select': ['mpegvideodec', 'vc1_decoder']},
 ...
 'mxf_muxer': {'select': ['iso_writer', 'pcm_rechunk_bsf', 'rangecoder'],
               'suggest': ['eia608_to_smpte436m_bsf']},
 'mxf_opatom_muxer': {'select': ['mxf_muxer']},
 'mxpeg_decoder': {'select': ['hpeldsp', 'mjpeg_decoder']},
 ...
 'nlmeans_vulkan_filter': {'deps': ['vulkan', 'spirv_library']},
 ...
 'ocio_filter': {'deps': ['libopencolorio']},
 ...
 'overlay_vulkan_filter': {'deps': ['vulkan', 'spirv_library']},
 'owdenoise_filter': {'deps': ['gpl']},
 'pad_cuda_filter': {'deps': ['ffnvcodec'],
                     'deps_any': ['cuda_nvcc', 'cuda_llvm']},
 'pad_opencl_filter': {'deps': ['opencl']},
 'pad_vaapi_filter': {'deps': ['vaapi_1']},
 ...
 'pcm_mulaw_at_encoder': {'deps': ['audiotoolbox'],
                          'select': ['audio_frame_queue']},
 'pdv_decoder': {'select': ['inflate_wrapper']},
 ...
 'prores_ks_vulkan_encoder': {'select': ['vulkan', 'spirv_compiler']},
 'prores_raw_decoder': {'select': ['blockdsp', 'idctdsp']},
 'prores_raw_vulkan_hwaccel': {'deps': ['vulkan', 'spirv_compiler'],
                               'select': ['prores_raw_decoder']},
 ...
 'prores_vulkan_hwaccel': {'deps': ['vulkan', 'spirv_compiler'],
                           'select': ['prores_decoder']},
 ...
 'rtsp_muxer': {'select': ['rtp_muxer',
                           ...
                           'rtp_protocol',
                           'rtpenc_chain']},
 'rtv1_decoder': {'select': ['texturedsp']},
 ...
 'rv40_decoder': {'select': ['golomb',
                             ...
                             'mpegvideodec',
                             'rv34dsp']},
 'rv60_decoder': {'select': ['videodsp', 'golomb']},
 'rv_zvbb': {'deps': ['rvv']},
 'rvv': {'deps': ['rv']},
 ...
 'scale_cuda_filter': {'deps': ['ffnvcodec'],
                       'deps_any': ['cuda_nvcc', 'cuda_llvm']},
 'scale_d3d11_filter': {'deps': ['d3d11va']},
 'scale_d3d12_filter': {'deps': ['d3d12va', 'id3d12videoprocessor']},
 ...
 'scale_vulkan_filter': {'deps': ['vulkan', 'spirv_compiler', 'spirv_library']},
 'scdet_filter': {'select': ['scene_sad']},
 'scdet_vulkan_filter': {'deps': ['vulkan', 'spirv_library']},
 ...
 'setend': {'deps': ['arm']},
 'shader_compression': {'suggest': ['zlib']},
 ...
 'sipr_decoder': {'select': ['lsp', 'celp_math']},
 'smartblur_filter': {'deps': ['gpl', 'swscale']},
 'sme': {'deps': ['aarch64', 'neon', 'sve', 'sve2']},
 'sme2': {'deps': ['aarch64', 'neon', 'sve', 'sve2', 'sme']},
 'sme_i16i64': {'deps': ['aarch64', 'neon', 'sve', 'sve2', 'sme']},
 'smoothstreaming_muxer': {'select': ['ismv_muxer']},
 'smpte436m_to_eia608_bsf': {'select': ['smpte_436m']},
 'smvjpeg_decoder': {'select': ['mjpeg_decoder']},
 'sndio_indev': {'deps': ['sndio']},
 'sndio_outdev': {'deps': ['sndio']},
 'snow_decoder': {'select': ['dwt', 'h264qpel', 'rangecoder', 'videodsp']},
 ...
 'spp_filter': {'deps': ['gpl', 'avcodec'],
                'select': ['idctdsp', 'fdctdsp', 'pixblockdsp']},
 'spx_muxer': {'select': ['ogg_muxer']},
 'sr_amf_filter': {'deps': ['amf']},
 ...
 'sve': {'deps': ['aarch64', 'neon']},
 'sve2': {'deps': ['aarch64', 'neon', 'sve']},
 'svq1_decoder': {'select': ['hpeldsp']},
 'svq1_encoder': {'select': ['hpeldsp', 'me_cmp', 'mpegvideoencdsp']},
 ...
 'swscale': {'deps': ['avutil'],
             'suggest': ['libm', 'stdatomic', 'spirv_library']},
 ...
 'trace_headers_bsf': {'select': ['cbs', 'cbs_vp8']},
 ...
 'transpose_vt_filter': {'deps': ['videotoolbox',
                                  'vtpixelrotationsessioncreate']},
 'transpose_vulkan_filter': {'deps': ['vulkan', 'spirv_library']},
 ...
 'vc1_d3d12va_hwaccel': {'deps': ['d3d12va'], 'select': ['vc1_decoder']},
 ...
 'vc1dsp': {'select': ['h264chroma', 'startcode']},
 'vc1image_decoder': {'select': ['vc1_decoder']},
 'vec_xl': {'deps': ['altivec']},
 'vflip_vulkan_filter': {'deps': ['vulkan', 'spirv_library']},
 'vfp': {'deps': ['arm']},
 'vfpv3': {'deps': ['vfp']},
 'vfwcap_indev': {'deps': ['vfw32', 'vfwcap_defines']},
 'videotoolbox': {'deps': ['corefoundation',
                           'coremedia',
                           'corevideo',
 ...
 'vp5_decoder': {'select': ['h264chroma', 'hpeldsp', 'videodsp', 'vp3dsp']},
 ...
 'vp8_mediacodec_encoder': {'deps': ['mediacodec']},
 ...
 'vp9_d3d11va_hwaccel': {'deps': ['d3d11va', 'dxva_picparams_vp9'],
                         'select': ['vp9_decoder']},
 'vp9_d3d12va_hwaccel': {'deps': ['d3d12va', 'dxva_picparams_vp9'],
                         'select': ['vp9_decoder']},
 ...
 'vp9_mediacodec_encoder': {'deps': ['mediacodec']},
 ...
 'vp9_videotoolbox_hwaccel': {'deps': ['videotoolbox'],
                              'select': ['vp9_decoder']},
 'vp9_vulkan_hwaccel': {'deps': ['vulkan', 'vulkan_1_4'],
                        'select': ['vp9_decoder']},
 'vpp_amf_filter': {'deps': ['amf']},
 ...
 'vulkan_1_4': {'deps': ['vulkan']},
 'vulkan_encode': {'deps': ['vulkan']},
 'vvc_decoder': {'select': ['cabac',
                            'cbs_h266',
                            'golomb',
                            'videodsp',
                            'vvc_sei']},
 'vvc_metadata_bsf': {'select': ['cbs_h266']},
 'vvc_parser': {'select': ['cbs_h266']},
 'vvc_qsv_decoder': {'select': ['vvc_mp4toannexb_bsf', 'qsvdec']},
 'vvc_sei': {'select': ['atsc_a53', 'golomb']},
 'vvc_vaapi_hwaccel': {'deps': ['vaapi', 'vapictureparameterbuffervvc'],
                       'select': ['vvc_decoder']},
 ...
 'webp_decoder': {'select': ['vp8_decoder']},
 'whip_muxer': {'select': ['dtls_protocol', 'rtp_muxer', 'http_protocol']},
 'whisper_filter': {'deps': ['whisper']},
 ...
 'wmavoice_decoder': {'select': ['lsp', 'sinewin']},
 ...
 'xfade_vulkan_filter': {'deps': ['vulkan', 'spirv_library']},
